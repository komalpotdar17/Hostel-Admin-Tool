...
<div id="page-wrapper">
	...
	<h2 class="mb-4 mr-2">Academic Year</h2><span>(All Years)</span>		  
    <div class="row">
    <div class="col-md-12">
     <form action="yearDB.jsp" method="post">
     <label><b>Year:</b></label>
     <input type="text" name="year" placeholder="Enter Year" class="form-control mt-2">
     <br>
     <input type="submit" value="Create Year" class="btn btn-success btn-sm float-right">
     </form>
     <br><br> 
    </div>
   <div class="col-md-12">
