...
<div id="page-wrapper">
    ...
    <h2 class="mb-4 mr-2">Course</h2><span>(All Courses)</span>
    <div class="row">
    <div class="col-md-12">
     <form action="mediumDB.jsp" method="post">
     <label><b>Medium name:</b></label>
     <input type="text" name="mediumname" placeholder="Enter Medium Name" class="form-control mt-2">
     <br>
     <input type="submit" value="Create Medium" class="btn btn-success btn-sm float-right">
     </form>
     <br><br> 
    </div>
   <div class="col-md-12">
...
<td><%=n %></td>
<td><%=rs.getString("medium_name") %></td>
