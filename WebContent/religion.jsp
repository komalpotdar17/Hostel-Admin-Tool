...
<div id="page-wrapper">
   ...
   <h2 class="mb-4 mr-2">Religion</h2><span>(All Religions)</span>
   <div class="row">
    <div class="col-md-12">
     <form action="religionDB.jsp" method="post">
     <label><b>Religion:</b></label>
     <input type="text" name="religionname" placeholder="Enter Religion" class="form-control mt-2">
     <br>
     <input type="submit" value="Create Religion" class="btn btn-success btn-sm float-right">
     </form>
     <br><br> 
    </div>
   <div class="col-md-12">
